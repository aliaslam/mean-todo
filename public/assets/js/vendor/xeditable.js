    ...
    angular.module('xeditable').directive(directiveName, ['editableDirectiveFactory',
      function(editableDirectiveFactory) {
        return editableDirectiveFactory({
          ...
          inputTpl: '<input ng-click="$event.stopPropagation();" type="'+type+'">'
        });
    }]);
  });
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button ng-click="$event.stopPropagation();" type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span></button>',
      cancelTpl:   '<button type="button" class="btn btn-default" ng-click="$form.$cancel();$event.stopPropagation();">'+
